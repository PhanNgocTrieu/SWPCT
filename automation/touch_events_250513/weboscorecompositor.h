...
public:
    ...
    CompositorExtension* webOS2DGraphicDeviceExtension();
    ...
    Q_INVOKABLE void updateVideoScale(const QString& s);
    ...
    Q_INVOKABLE void startTest() {
        AutoTestFunctionalController::instance()->startTest();
    }

    Q_INVOKABLE void stopTest() {
        AutoTestFunctionalController::instance()->stopTest();
    }

    Q_INVOKABLE void setupTest() {
        AutoTestFunctionalController::instance()->setup();
    }

    bool getTestMode() {
        return AutoTestFunctionalController::instance()->getTestMode();
    }

    void setConfirmTouchTestMode(bool confirmTouch) {
        AutoTestFunctionalController::instance()->setConfirmTouchTestMode(confirmTouch);
    }

    bool getConfirmTouchTestMode() {
        return AutoTestFunctionalController::instance()->getConfirmTouchTestMode();
    }

    void receivedTouch() {
        emit AutoTestFunctionalController::instance()->receivedTouch();
    }
